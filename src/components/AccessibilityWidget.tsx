        ...
        >
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <button className="font-btn" onClick={diminuirFonte} disabled={fontSizeModifier <= 12} aria-label="Diminuir fonte">
                A−
              </button>
              ...
              <button className="font-btn" onClick={aumentarFonte} disabled={fontSizeModifier >= 22} aria-label="Aumentar fonte">
                A+
              </button>
              <button className="font-btn" onClick={resetarFonte} aria-label="Resetar fonte" title="Resetar">
                ↺
              </button>
            </div>
          </div>
