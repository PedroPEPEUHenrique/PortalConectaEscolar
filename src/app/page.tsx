...
const cards = [
  { titulo: "Atividades",    descricao: "Gerencie tarefas, trabalhos e avaliações de forma centralizada.", link: "/activities" },
  { titulo: "Calendário",    descricao: "Acompanhe eventos, provas e datas importantes do ano letivo.",    link: "/calendario"  },
  { titulo: "Comunidade",    descricao: "Fique por dentro das novidades e comunicados escolares.",          link: "/comunidade"  },
  { titulo: "Suporte (SAC)", descricao: "Envie sugestões, dúvidas e opiniões para a equipe escolar.",     link: "/feedback"    },
];
